...
<div class="font">
    ...
    <div class="register">
        ...
        <div class="admin_buttons">
            ...
            <a href="/Event_register"><input class= "submit_button" type="Submit" value="REGISTER FOR EVENTS "/></a></br>
        <a href="/Events_view"> <input class= "submit_button" type="Submit" value="VIEW ALL EVENTS"/></a></br>
            <a href="/Edit_profile"> <input class= "submit_button" type="Submit" value="EDIT PROFILE"/></a></br></br></br></br>
